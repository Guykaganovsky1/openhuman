...
const messages: TranslationMap = {
  ...
  'channels.connectHelp.imessage':
    '无需凭据。OpenHuman 需要读取本地「信息」数据库，请在「系统设置 > 隐私与安全性 > 完全磁盘访问权限」中为它开启权限，然后重启应用。',
  ...
  'pages.settings.features.toolsDesc': '按类别分组，逐项开启或关闭智能体工具。',
  ...
  'rewards.referralSection.apply': '应用',
