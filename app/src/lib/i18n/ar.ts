...
const messages: TranslationMap = {
  ...
  'chat.deleteThreadAria': 'حذف المحادثة {title}',
  ...
  'chat.renameThreadAria': 'إعادة تسمية المحادثة {title}',
  ...
  'composio.authRevoked': 'تم إلغاء الوصول',
  ...
  'channels.connectHelp.imessage':
    'لا حاجة إلى بيانات اعتماد. يقرأ OpenHuman قاعدة بيانات الرسائل المحلية، لذا امنحه وصولاً كاملاً إلى القرص من إعدادات النظام > الخصوصية والأمان > الوصول الكامل إلى القرص، ثم أعد تشغيل التطبيق.',
  ...
  'pages.settings.features.toolsDesc': 'شغّل أدوات الوكيل أو أوقفها بشكل فردي، مجمّعة حسب الفئة.',
  ...
  'rewards.referralSection.apply': 'تطبيق',
