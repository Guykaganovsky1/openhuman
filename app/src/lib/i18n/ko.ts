...
const messages: TranslationMap = {
  ...
  'channels.connectHelp.imessage':
    '자격 증명이 필요 없습니다. OpenHuman은 로컬 메시지 데이터베이스를 읽으므로 시스템 설정 > 개인 정보 보호 및 보안 > 전체 디스크 접근 권한에서 권한을 허용한 뒤 앱을 다시 실행하세요.',
  ...
  'pages.settings.features.toolsDesc': '카테고리별로 묶인 에이전트 도구를 하나씩 켜거나 끕니다.',
  ...
  'rewards.referralSection.apply': '적용',
